...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgqCHl7zAM2AFYCOAAFd30sb1Ck089.png" alt="image (7).png" style="zoom: 80%;" />
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgqCHl7zAQmAWvyUAAE_mgzi5xE933.png" alt="image (8).png" style="zoom: 50%;" />
...
3. didUpdateWidget 触发 build 我们需要从代码层面来讲解下，现在我们需要设计两个组件，一个是我们刚实现的 TestStatefulWidget ，另外一个则是该组件的子组件，我们命名为SubStatefulWidget 。接下来我们在 TestStatefulWidget 加载该组件，在头部 import 该组件，然后将 build 中的代码修改为下面：
    ...
    <img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgqCHl7zATCAcLoKAAEryO5AHrk427.png" alt="image (9).png" style="zoom: 50%;" />
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgqCHl7zAWyAf3hFAAt1uKBbpwY045.gif" alt="20200610_140500-2.gif" style="zoom:50%;" />
