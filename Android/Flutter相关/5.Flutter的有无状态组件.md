##  有/无状态组件：如何巧妙地应用 Flutter 有/无状态组件
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/Ciqc1F7zAciAV3kHAAsOqdx9yX8344.png" alt="image (10).png" style="zoom:50%;" />
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/Ciqc1F7zAdOAel6TAAtwHZn7wQw909.png" alt="image (11).png" style="zoom:50%;" />

<center>图 2 组件标记</center>

第二步：**记录组件名称以及组件数据**，以及标记动态数据，我们使用下面的表格 1 来处理，并且将每个小组件命名好。

<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/Ciqc1F7zAemAA3hwAACRl_hUd40759.png" alt="image (12).png" style="zoom:50%;" />
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgqCHl8MPo6AfA-wAACs_VZfuQw592.png" alt="5.png" style="zoom:50%;" />
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgqCHl8MPp2AZhKfAADFimfXDyg939.png" alt="6.png" style="zoom:50%;" />

<center>图 4 优化后的组件设计图</center>

这样就完成了组件的分析和设计，按照这种方式，我们再实现其中的组件代码，完成界面效果。接下来我们将组件进行命名，将表格 1 根据上图的设计重新修改下，如表格 2 。

<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/Ciqc1F7zAgaAJ59xAABi3IF6Ycw572.png" alt="image (15).png" style="zoom:50%;" />
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/Ciqc1F7zAg2AAeVzAACV_ulkeyM179.png" alt="image (16).png" style="zoom:50%;" />
...
- 二级组件
    ...
    <img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/Ciqc1F7zAi6AIamAAAnwMrGReX8255.png" alt="image (17).png" style="zoom:50%;" />
