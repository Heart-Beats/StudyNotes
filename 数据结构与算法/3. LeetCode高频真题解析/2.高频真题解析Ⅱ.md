...
![img](https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgotOV2IeoeAXmexAABQeDb1BWQ016.png)
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgotOV2IeomAZY5oAFqba-5PZJc045.gif" alt="img" style="zoom:50%;" />
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgoB5l2IeomAJypIAAA1_CqUqGA909.png" alt="img" style="zoom: 80%;" />

1. 如果只考虑保留 B 的情况，而不考虑把 B 删除的情况，那么就会错过一个答案，因为在这个情况下，把 B 删除，只剩下 A 和 C，它们互不重叠，也能得到最优的解。

2. 遇到 A 和 B 相互重叠的情况时，必须要考虑把 B 删除掉。

    <img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgotOV2IeomAasCyABO9nAPnBLM742.gif" alt="img" style="zoom:50%;" />

    为什么不把 A 删除呢？因为如果把 A 删了，B 和 C 还是可能会重叠，则需要删除掉更多的区间，不满足题目要求。

    <img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgoB5l2IeoqAMYGUAB4TTFLJ7aA153.gif" alt="img" style="zoom:50%;" />
...
1. A 和 B 重叠，由于 A 结束得比较晚，此时删除区间 A，保留区间 B。
    ...
    <img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgoB5l2IeouALsHDACoIa6RqiFk139.gif" alt="img" style="zoom:50%;" />

2. B 和 C 重叠，由于 C 结束得晚，把区间 C 删除，保留区间 B。

    <img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgotOV2IeouAVgkTACrf8XPAR8o811.gif" alt="img" style="zoom:50%;" />

3. B 和 D 不重叠，结束，一共只删除了 2 个区间。

    <img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgoB5l2IeoyAS7VEABGI5Z_ovpM719.gif" alt="img" style="zoom:50%;" />
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgotOV2IeoyAMCcNAABEWLc4h90512.png" alt="img" style="zoom: 80%;" />
...
1. 比较以 w 开头的字符串，它们是 wrt 和 wrf，之所以 wrt 会排在 wrf 之前，是因为 t 比 f 在火星字典里出现的顺序要早。此时将这两个字母的关系表达为 t -> f。
    ...
    <img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgotOV2Ieo2AUKzRAB96MtWjhn0834.gif" alt="img" style="zoom:50%;" />

2. 比较 wrf 和 er，第一个字母开始不同，因此，得出 w 排在 e 之前，记为 w -> e。

    <img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgoB5l2Ieo2AHp2gABsjRhdqs-o833.gif" alt="img" style="zoom:50%;" />

3. 比较 er 和 ett，从第二个字母开始不一样，因此，得出 r 排在 t 之前，记为 r -> t。

    <img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgotOV2Ieo6AGzbmABkoJlXVd6Q543.gif" alt="img" style="zoom:50%;" />

4. 比较 ett 和 rftt，从第一个字母开始不一样，得出 e 排在 r 之前，记为 e -> r。

    <img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgoB5l2Ieo-AQsABACwHvWpfLUM265.gif" alt="img" style="zoom:50%;" />
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgotOV2Ieo-AL2rOAAA-SDWivvo697.png" alt="img" style="zoom:80%;" />
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgoB5l2Ieo-AfXiGAB41ZU6ORu4144.gif" alt="img" style="zoom:50%;" />
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgotOV2IepCADkCaAAA9qnc1K_8002.png" alt="img" style="zoom: 80%;" />
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgotOV2IepKAGgQSAIKuyG7w9pk329.gif" alt="img" style="zoom:50%;" />
...
<img src="https://raw.githubusercontent.com/Heart-Beats/Note-Pictures/main/images/CgoB5l2IepSAeUhVAFLy8rXwn-M290.gif" alt="img" style="zoom:50%;" />
